...
function _handler(event) {
  ...
  var country = countryHeader?.value ? countryHeader.value : "US";
  ...
  if (uri.indexOf("/main.html") === 0) {
    ...
    const html =
      ...
      hero +
      ',#0a0b0d);color:#fff;border-radius:14px;padding:22px 24px;margin-bottom:16px">' +
      ...
      '<p style="margin:0;opacity:.9">Unlocked for a reader in ' +
      country +
      " · issue #" +
      rint(100, 999) +
      "</p>" +
      ...
      "</div>" +
      '<blockquote style="margin:0;border-left:3px solid ' +
      hero +
      ';padding:6px 14px;color:#5b616e">“Pay-per-request content, settled on Base Sepolia.”</blockquote>' +
      '<p style="margin:14px 0 0;font-size:12px;color:#7c828a">Served by a CloudFront Function · build ' +
      rint(10000, 99999) +
      "</p>" +
      "</article>";
